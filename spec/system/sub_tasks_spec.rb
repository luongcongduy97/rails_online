  ...
  describe 'SubTask#create' do
    it 'allows creating' do
      ...
      expect do
        within('#new_sub_task') do
          # Find the visible Flatpickr input (text input generated by Flatpickr)
          find('input.form-control').click
          execute_script("document.querySelector('.flatpickr-day:not(.flatpickr-disabled)').click();")
          click_on 'Create'
          sleep 0.5
        end
    ...
    it 'shows errors when due date is not unique within the task' do
      ...
      expect do
        within('#new_sub_task') do
          find('input.form-control').click
          execute_script("document.querySelector('input.flatpickr-input')._flatpickr.setDate('#{existing_due_date}')")
          click_on 'Create'
          sleep 0.5
        end
